...
export default function Signup() {
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      <h1 className="text-4xl font-extrabold mb-6 gradient-text">Create your account</h1>
      <form onSubmit={submit} className="space-y-4 glass p-6 rounded-xl">
        ...
        <button className="px-6 py-3 rounded-full bg-primary/20 border border-primary/40 text-primary shadow-glow" type="submit">Sign up</button>
      </form>
      <p className="text-sm text-zinc-400 mt-4">Have an account? <Link to="/login" className="text-accent">Log in</Link></p>
    </div>
  );
}
